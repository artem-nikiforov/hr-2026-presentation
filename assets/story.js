(function (root) {
  ...
  const stories = [
    ...
    {
      camera: [-.6, .2, 1.05],
      music: 'drive',        /* «Ритмичная, с лёгким басом» */
    ...
    {
      camera: [0, 0, 1.035],
      music: 'epic',         /* «резкий переход на эпичную музыку» */
      html: `<div class="layer">
    ...
    {
      camera: [.5, -.15, 1.05],
      music: 'confident',    /* «Возвращается бодрая, уверенная музыка» */
      html: `<div class="layer lower-copy">
    ...
    {
      camera: [.2, -.1, 1.04],
      music: 'warm',         /* «более тёплая, вдохновляющая, но с драйвом» */
      avatarAt: 0,
